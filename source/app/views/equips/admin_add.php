    ...
    <?php echo $form->create("Equip",array('controller'=>'equips','action'=>'add'),array("enctype"=>"multipart/form-data"));?>
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="control-group">
	        ...
	        <div class="controls">
	            <?php echo $form->textarea('chucnang',null,array('class'=>'span8','id'=>'chucnang'));?>
	        </div>
        </div>
        <div class="control-group">
