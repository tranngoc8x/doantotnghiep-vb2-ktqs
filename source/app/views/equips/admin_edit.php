    ...
    <div class="row-fluid">
      <div class="span8">
        ...
        <div class="control-group">
          	...
          	<div class="controls">
            	<?php echo $form->input('ten',array('class'=>'span12','id'=>'ten','value'=>$equip['Equip']['ten']));?>
        	</div>
        </div>
        <div class="control-group">
	        <label class="control-label" for="chucnang">Chức năng</label>
	        <div class="controls">
	           <?php echo $form->textarea('chucnang',$equip['Equip']['chucnang'],array('class'=>'span12','id'=>'chucnang'));?>
	        </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
          	...
          	<div class="controls">
            	<?php echo $form->textarea('gioithieu',$equip['Equip']['gioithieu'],array('class'=>'span12','id'=>'gioithieu'));?>
          	</div>
        </div>
        <div class="control-group">
	        <label class="control-label" for="anh">Ảnh thiết bị</label>
	        <div class="controls">
	            <?php echo $form->input('anh',array('class'=>'span12','id'=>'anh','value'=>$equip['Equip']['anh']));?>
	        </div>
        </div>
