...
<div class="mass mass-top clearfix">
	...
	<div class="boxheader boxheader-main clearfix">
        ...
        <div class="box-ct clearfix row-fluid">
            ...
            <?php $comments = CommonsController::showpost($drugstore['Drugstore']['id']);?>
            <div class='span12 article detail'>
	            <?php
	                $show_more_button = count($comments);
	            ?>
	            <input type='hidden' name='itemid' id='itemid' value="t2_<?php echo $drugstore['Drugstore']['id'];?>" />
	                 ...
	                 ?>
	                       <div class="friends_area" id="record-<?php  echo $item['Comment']['id']?>">
	                            ...
	                            <div id="CommentPosted<?php  echo $item['Comment']['id']?>">
	                                <?php
	                                $comment_num_row = count($item['Ykien_drugstore_child']);
	                                if($comment_num_row > 0)
	                                {
	                                    foreach ($item['Ykien_drugstore_child'] as $value)
	                                    {
	                                    ?>
