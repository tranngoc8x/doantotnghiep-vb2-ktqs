<div class="mass mass-top clearfix">
            ...
            <form action="<?php echo BASE_PATH;?>/commons/find" method="POST" class="span12">
                ...
                <div class="span4">
                    <select name="type" id="type" class="span12">
                        ...
                        ?>
                        <option value="<?php echo $value['Menu']['id'];?>" <?php if($value['Menu']['id']==$idtype){echo "selected";}?>><?php echo $value['Menu']['ten'];?></option>
                        <?php }?>
                    </select>
    ...
    <div class="boxheader boxheader-main clearfix">
        ...
        <form action="types" id='frm' method='POST' class='right' style='margin:-5px 0 0;'>
