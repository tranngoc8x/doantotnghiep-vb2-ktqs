    ...
    <?php echo $form->create("Contact",array('controller'=>'hopitals','action'=>'edit/'.$hopital['Hopital']['id']));?>
    ...
    <div class="row-fluid">
      <div class="span8">
        ...
        <div class="control-group">
            ...
            <div class="controls">
              <?php echo $form->input('ten',array('class'=>'span12','id'=>'ten','value'=>$hopital['Hopital']['ten']));?>
          </div>
        </div>
        <div class="control-group">
          <label class="control-label" for="diachi">Địa chi</label>
          <div class="controls">
              <?php echo $form->input('diachi',array('class'=>'span12','id'=>'diachi','value'=>$hopital['Hopital']['diachi']));?>
          </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
              <?php echo $form->textarea('gioithieu',$hopital['Hopital']['gioithieu'],array('class'=>'span12','id'=>'gioithieu'));?>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="map">Vị trí trên bản đồ</label>
            <div class="controls">
               <?php echo $form->input('map',array('class'=>'span12','id'=>'map','value'=>$hopital['Hopital']['map']));?>
            </div>
        </div>
