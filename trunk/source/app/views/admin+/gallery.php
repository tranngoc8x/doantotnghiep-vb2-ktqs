...
<head>
	...
	<!-- Theme -->
	<link rel="stylesheet/less" href="theme/less/style.less?1361270229" />
		...
		<div class="navbar main">
			...
			<ul class="topnav pull-right">
				...
				<li class="dropdown visible-desktop">
			    	...
			    	<ul class="dropdown-menu pull-right">
			      		<li class="active"><a href="gallery.php" title="English"><img src="theme/images/lang/en.png" alt="English"> English</a></li>
			      		<li><a href="gallery.php" title="Romanian"><img src="theme/images/lang/ro.png" alt="Romanian"> Romanian</a></li>
			      		<li><a href="gallery.php" title="Italian"><img src="theme/images/lang/it.png" alt="Italian"> Italian</a></li>
			      		<li><a href="gallery.php" title="French"><img src="theme/images/lang/fr.png" alt="French"> French</a></li>
			      		<li><a href="gallery.php" title="Polish"><img src="theme/images/lang/pl.png" alt="Polish"> Polish</a></li>
			    	</ul>
				</li>
				<li class="account">
					...
					<ul class="dropdown-menu pull-right">
						...
						<li class="highlight profile">
							<span>
								<span class="heading">Profile <a href="form_demo" class="pull-right">edit</a></span>
								<span class="img"></span>
								<span class="details">
		...
		<div id="menu" class="hidden-phone">
			<div id="menuInner">
				...
				<ul>
					...
					<li class="">
						<a class="glyphicons table" href="tables"><i></i><span>Tables</span></a>
					</li>
				...
				<ul>
					...
					<li class="glyphicons picture active"><a href="gallery.php"><i></i><span>Photo Gallery</span></a></li>
...
<h3 class="glyphicons picture"><i></i> Photo Gallery</h3>
<div class="separator"></div>
...
<div class="well">
	<div class="row-fluid gallery">
		<ul>
				...
				<span class="thumb view">
					<img src="theme/images/gallery/rs/1.jpg" alt="Album" />
				</span>
				<span class="name"></span>
			</li>
						<li class="span4">
				<span class="thumb view">
					<img src="theme/images/gallery/rs/2.jpg" alt="Album" />
				</span>
				<span class="name"></span>
			</li>
						<li class="span4">
				<span class="thumb view">
					<img src="theme/images/gallery/rs/3.jpg" alt="Album" />
				</span>
				<span class="name"></span>
			</li>
						<li class="span4">
				<span class="thumb view">
					<img src="theme/images/gallery/rs/4.jpg" alt="Album" />
				</span>
				<span class="name"></span>
			</li>
						<li class="span4">
				<span class="thumb view">
					<img src="theme/images/gallery/rs/5.jpg" alt="Album" />
				</span>
				<span class="name"></span>
			</li>
						<li class="span4">
				<span class="thumb view">
					<img src="theme/images/gallery/rs/6.jpg" alt="Album" />
				</span>
				<span class="name"></span>
			</li>
						<li class="span4">
				<span class="thumb view">
					<img src="theme/images/gallery/rs/7.jpg" alt="Album" />
				</span>
				<span class="name"></span>
			</li>
						<li class="span4">
				<span class="thumb view">
					<img src="theme/images/gallery/rs/8.jpg" alt="Album" />
				</span>
				<span class="name"></span>
			</li>
						<li class="span4">
				<span class="thumb view">
					<img src="theme/images/gallery/rs/9.jpg" alt="Album" />
				</span>
				<span class="name"></span>
			</li>
						<li class="span4">
				<span class="thumb view">
					<img src="theme/images/gallery/rs/10.jpg" alt="Album" />
				</span>
				<span class="name"></span>
			</li>
						<li class="span4">
				<span class="thumb view">
					<img src="theme/images/gallery/rs/11.jpg" alt="Album" />
				</span>
				<span class="name"></span>
			</li>
						<li class="span4">
				<span class="thumb view">
					<img src="theme/images/gallery/rs/12.jpg" alt="Album" />
				</span>
				<span class="name"></span>
			</li>
					</ul>
	...
	<!-- Masonry -->
	<script src="theme/scripts/jquery.masonry.min.js"></script>
	<script>
