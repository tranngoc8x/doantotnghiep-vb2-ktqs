...
<head>
	...
	<!-- Theme -->
	<link rel="stylesheet/less" href="theme/less/style.less?1361270212" />
		...
		<div class="navbar main">
			...
			<ul class="topnav pull-right">
				...
				<li class="dropdown visible-desktop">
			    	...
			    	<ul class="dropdown-menu pull-right">
			      		<li class="active"><a href="pages.php" title="English"><img src="theme/images/lang/en.png" alt="English"> English</a></li>
			      		<li><a href="pages.php" title="Romanian"><img src="theme/images/lang/ro.png" alt="Romanian"> Romanian</a></li>
			      		<li><a href="pages.php" title="Italian"><img src="theme/images/lang/it.png" alt="Italian"> Italian</a></li>
			      		<li><a href="pages.php" title="French"><img src="theme/images/lang/fr.png" alt="French"> French</a></li>
			      		<li><a href="pages.php" title="Polish"><img src="theme/images/lang/pl.png" alt="Polish"> Polish</a></li>
			    	</ul>
				</li>
				<li class="account">
		...
		<div id="menu" class="hidden-phone">
			<div id="menuInner">
				...
				<ul>
					...
					<li class="glyphicons sort active"><a href="pages.php"><i></i><span>Site Pages</span></a></li>
